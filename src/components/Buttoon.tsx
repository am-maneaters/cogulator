...
type ButtoonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  transparent?: boolean;
};

export const Buttoon = ({ className, transparent, ...props }: ButtoonProps) => (
  <button
    className={clsx(
      ...
      `p-1 text-white shadow-[-1px_2px_4px_2px_rgba(0,0,0,0.5)] hover:shadow-xl
